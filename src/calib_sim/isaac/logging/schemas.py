...
class IsaacTagDetectionPacket:
    ...
    def as_json(self) -> dict[str, Any]:
        return {
            ...
            "measurement_source": str(self.measurement_source),
            "temporal_gap_frames": int(self.temporal_gap_frames),
...
class IsaacControllerDiagnosticPacket:
    ...
    actual_control_position_world_m: tuple[float, float, float] | None = None
    actual_ee_position_world_m: tuple[float, float, float] | None = None
    ik_target_position_world_m: tuple[float, float, float] | None = None
    target_ee_position_world_m: tuple[float, float, float] | None = None
    ...
    def csv_fieldnames(cls) -> list[str]:
        return [
            ...
            "orientation_policy",
            "actual_control_position_world_m",
            "actual_ee_position_world_m",
    ...
    def to_csv_row(self) -> dict[str, Any]:
        return {
            ...
            "actual_control_position_world_m": ""
            if self.actual_control_position_world_m is None
            else _pipe_join(self.actual_control_position_world_m),
            "actual_ee_position_world_m": ""
            if self.actual_ee_position_world_m is None
            else _pipe_join(self.actual_ee_position_world_m),
            "ik_target_position_world_m": ""
            if self.ik_target_position_world_m is None
            else _pipe_join(self.ik_target_position_world_m),
            "target_ee_position_world_m": ""
            if self.target_ee_position_world_m is None
            else _pipe_join(self.target_ee_position_world_m),
            "camera_orientation_error_deg": None
            if self.camera_orientation_error_deg is None
            else float(self.camera_orientation_error_deg),
